...
if __name__ == '__main__':
    ...
    if arg.lang=='V':
        ...
        TRAIN_PATH = ['./dataset/English-Vietnamese/trainset/train.en.txt', './dataset/English-Vietnamese/trainset/train.vi.txt']
        VOCAB_PATH = ['dataset/English-Vietnamese/Vocabularies/vocab.en.txt', 'dataset/English-Vietnamese/Vocabularies/vocab.vi.txt']
        TEST_PATH = ['./dataset/English-Vietnamese/testset/tst2013.en.txt', './dataset/English-Vietnamese/testset/tst2013.vi.txt']
    elif arg.lang=='G':
        model_name = 'German'
...
#     print(random.choice(pairs))
    ...
    if arg.mode=='train':
        ...
        attn_decoder1.load_state_dict(torch.load('model/decoder'+model_name+'.pt'))
        while True:
            print("Please enter your sentence in English")
            string = str(input())
